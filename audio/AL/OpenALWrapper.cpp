...
bool loadAL()
{
	...
	alListenerf = reinterpret_cast<LPALLISTENERF>(dlsym(libopenal,"alListenerf"));
	alListener3f = reinterpret_cast<LPALLISTENER3F>(dlsym(libopenal,"alListener3f"));
	alListenerfv = reinterpret_cast<LPALLISTENERFV>(dlsym(libopenal,"alListenerfv"));
	alListeneri = reinterpret_cast<LPALLISTENERI>(dlsym(libopenal,"alListeneri"));
	alListener3i = reinterpret_cast<LPALLISTENER3I>(dlsym(libopenal,"alListener3i"));
	alListeneriv = reinterpret_cast<LPALLISTENERIV>(dlsym(libopenal,"alListeneriv"));
